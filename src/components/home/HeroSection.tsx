      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-4 w-full">
              {stats.map(stat => (
                <div key={stat.label} className="flex items-center gap-3 p-3 rounded-xl bg-card/50 border border-border/30">
